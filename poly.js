...
function clear_canvas2(src) {
  ctx = undefined;
  perimeter = new Array();
  complete = false;
  document.getElementById('coordinates').value = '';
  console.log('clear_canvas2', src)
  start((src = src));
}

// function handleFileSelect(event) {
//   var file = event.target.files[0];
// //   canvas.setAttribute("data-imgsrc", file["name"]);
// //   console.log("skcsdckjmskcsd", file["name"]);

//   var reader = new FileReader();
//   reader.onload = function (event) {
//     // img.src = event.target.result;
//     console.log('handle file', event.target.result)
//     clear_canvas2(event.target.result);
//   };
//   reader.readAsDataURL(file);
// }

// function start(with_draw, src) {
//   var img = new Image();
